...
===========================
*Created on 09.01.2024 by Tobias Witte*
*Copyright (C) 2024*
*For COPYING and LICENSE details, please refer to the LICENSE file*

Test if your PyTorch installation and AMD plus ROCm drivers installation works on the gpu
"""
import grp
import os
import pwd
...
try:
    ...
    if len(devices) > 0:
        print('ROCM devices found: ', len(devices))
    else:
        print('No ROCM devices found.')
